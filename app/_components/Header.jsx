    ...
    py-6  shadow-sm '>
      ...
      <div className='flex gap-3 items-center'>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuSeparator />
        <Link href={'/user'}>  <DropdownMenuItem>Профиль</DropdownMenuItem></Link>
         <Link href={'/user#/my-orders'}> <DropdownMenuItem>Мои заказы</DropdownMenuItem></Link>
          <DropdownMenuItem> <SignOutButton>Выйти</SignOutButton></DropdownMenuItem>
